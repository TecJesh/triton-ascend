...
class pointer_type(dtype):
    ...
    def to_ir(self, builder: ir.builder) -> ir.pointer_type:
        ...
        # Accept legacy numeric address spaces (1=global, 0=descriptor,
        # 4=constant) alongside the named ones.
        address_space = _unwrap_if_constexpr(address_space)
        if isinstance(address_space, int):
            address_space = {1: "global", 0: "descriptor", 4: "constant"}.get(address_space, "global")
...
class _block_ptr:
    ...
    def _set_name(self, builder: ir.builder, name: str) -> None:
        # The block pointer is a python-side abstraction; its component tensors
        # are named when they are created.
        return
