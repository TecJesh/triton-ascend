...
def install() -> None:
    ...
    _bk_compiler_mod.AttrsDescriptor = _AttrsDescriptor
    ...
    _bl = _AutoModule("triton.extension.buffer.language")
    ...
    _tools = _make_module("triton.tools")
    _make_module("triton.tools.disasm", parent=_tools)
    _tools_ascend = _make_module("triton.tools.get_ascend_devices", parent=_tools)
    _tools_ascend.is_compile_on_910_95 = False
    ...
    for _name in ["pybind11", "torch", "torch.nn", "torch._C", "torch_npu"]:
